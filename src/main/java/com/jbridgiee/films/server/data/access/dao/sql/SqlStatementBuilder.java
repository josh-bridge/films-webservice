...
public class SqlStatementBuilder {
    ...
    public SqlStatementBuilder(String select, String fields, String from, String where, String like) {
        this.select = select;
        this.fields = fields;
        this.from = from;
        this.where = where;
    ...
    public class StatementBuilder {
        ...
        public FromBuilder select(String fields) {
            return from -> where -> like -> new SqlStatementBuilder(
                    "SELECT ",
                    fields + " ",
                    from,
                    where,
        ...
        public FromBuilder selectAll() {
            return table -> where -> like -> new SqlStatementBuilder(
                    "SELECT ",
                    "* ",
                    "FROM " + table + " ",
                    "WHERE " + where + " ",
    ...
    public interface LikeBuilder {
        SqlStatementBuilder like(String like);
    }
}
